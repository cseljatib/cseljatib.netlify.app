...
| Nombre      |  Descripción |
| ----------- | ----------- |
| [**¿Por qué R?**](/rlibro/01porQueR.pdf)| Se resumen las principales bondades de R.  |
| [**Instalar R y paquetes**](/rlibro/02instalaR.pdf)   | ¿Cómo instalar el software?, y otros relacionados.  |
...
Tal como se explica en [el material de ayuda](#ayuda), este paquete también puede ser  instalado desde su archivo fuente [de extensión .tar.gz](https://cran.r-project.org/src/contrib/datana_1.0.1.tar.gz). 
...
Para aquellos usuarios que usan cotidianamente el paquete, y dado que la actualizacion en el repositorio de CRAN es algo mas lenta, dejo a continuacion links a versiones no-oficiales del paquete y del manual de este mismo.

+ [**datana_1.0.1.tar.gz**](/rlibro/datana_1.0.1.tar.gz)  `(nueva versión, 4 de noviembre 2022)`
